      ...
      <header className="fixed top-0 left-52 right-0 h-14 bg-card border-b border-border flex items-center px-6 z-40">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 pl-3 border-l border-border">
            ...
            <button onClick={handleLogout} title="Sign out" className="w-8 h-8 flex items-center justify-center text-muted-foreground hover:text-destructive transition-colors">
